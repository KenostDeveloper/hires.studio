...
export default function PhotoComponents() {
    ...
    function updatePhoto() {
        ...
        axios.get(`/api/photo?limit=20&page=${currentPage}&type=Interior`).then(res => {
    ...
    <div>
        <div className={styles.typePhoto}>
            <div className={`container ${styles.container}`}>
                ...
                <Link href="/photo/interior" className={`${styles.typePhotoTitle} ${styles.active}`}>Интерьерная</Link>
