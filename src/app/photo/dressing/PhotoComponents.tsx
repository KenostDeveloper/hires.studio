...
export default function PhotoComponents() {
    ...
    function updatePhoto() {
        ...
        axios.get(`/api/photo?limit=20&page=${currentPage}&type=DressingRoom`).then(res => {
    ...
    <div>
        <div className={styles.typePhoto}>
            <div className={`container ${styles.container}`}>
                ...
                <Link href="/photo/dressing" className={`${styles.typePhotoTitle} ${styles.active}`}>Гримерка</Link>
            </div>
        </div>
