  ...
  const [faqs, setFaq] = useState([
    {
      ...
      card: [
        {
          id: 0,
          name: "Sony FX-30 (5 шт)",
          description:
            "профессиональная кинокамера. Не греется, не разряжается (встроенный v-mount), с потрясающей красочной картинкой. Пишет файл без остановок. У нас 5 таких камер, хватит всем 🙂. Объективы идеально подобраны под подкасты, Reels и разговорные видео",
          img: "./bg/faq/12.jpg",
        },
        {
          id: 1,
    ...
    },
    {
      ...
      card: [
        {
          id: 0,
          name: "Легендарные микрофоны Shure Sm7b (3 шт)",
          description:
            "динамические микрофоны, которые запишут только ваш голос и ничего лишнего. Микрофоны сделают голос бархатным, радийным. К ним есть компактные стойки или более комфортные пантографы. Каждый микрофон подключен к преусилителю (активатору) для усиления сигнала. Если вам не хватит этиъ микрофонов, у нас есть их младший брат — не менее классный Shure mv7 (2 штуки)",
          img: "./bg/faq/13.jpg",
        },
        {
          id: 1,
          ...
          description:
            "легендарная петличная радиосистема с потрясающим звуком и уровнем приема и передачи звука. Подходит для интервью или разговорных видео. Еще у нас есть Rode Wireless Pro, тоже крутые петлички с 32 битным звуком.",
          img: "./bg/faq/14.jpg",
        },
        {
          id: 2,
        ...
        {
          id: 3,
          name: "Звуковой рекордер Zoom F6",
          description:
            "это профессиональный инструмент для записи звука, который используется в кино. Он записывает высокакачественный звук, поддерживает до шести микрофонов одновременно. И самая крутая фишка — 32 бита. Благодаря чему, люые крики в микрофон или разговоры шепотом, можно вытянуть без дефектов, буквально в пару кликов. Звук мы обработаем, наложив плагины бесплатно. И, конечно, оставим вам исходные файлы.",
          img: "./bg/faq/11.png",
        },
      ],
    },
    {
      ...
      card: [
        {
          id: 0,
          name: "Видеосвет Amaran",
          description:
            "в студии в качестве основных источников видеосвета, мы используем только продукцию от Amaran. Это очень качественный свет с гибкими настройками. У нас около 3х Amaran 100, несколько 60, есть даже 200 и цветной Amaran 150с с масками Гобо, позволяющий рисовать световые узоры. Выглядит очень круто! Ко всему есть софтбоксы, само собой.",
          img: "./bg/faq/15.jpg",
        },
        {
          id: 1,
      ...
      card: [
        {
          ...
          name: "Телесуфлер",
          description:
            "незаменимый помощник для разговорных видео, курсов, и даже подкастов. Управлять текстом можно прямо в процессе съемки. Читайте текст, а смотрите прямо в камеру! ",
          img: "./bg/faq/17.jpg",
        },
        {
          id: 1,
          name: "Камера Fujfilm Xt-3",
          description:
            "хорошая 4к камера с приятным цветом. На нее отлично можно записать горизонтальные или вертикальные видео. Не перегреваются. Их мы не используем в съемках, но готовы сдать в аренду.",
          img: "./bg/faq/18.jpg",
        },
        {
          id: 3,
          name: "Atem Mini Pro",
          description:
            "незаменимый помощник в мониторинге картинки и прямых эфирах. В это устройство подключены все камеры, которые наши гости видят во время съемки на телевизоре в студии и в гримерке. Так, мы сможем согласовать с вами ракурс, и убедиться, что вы выглядите великолепно",
          img: "./bg/faq/19.jpg",
        },
        {
          id: 2,
